...
import { FaFacebook, FaTiktok, FaTwitter, FaGithub, FaInstagram } from 'react-icons/fa'

const Footer = () => {
    return (
        <div className='rounded-div mt-8 pt-8 text-primary'>
            <div className='grid md:grid-cols-2'>
                <div className='flex justify-evenly w-full md:max-w-xs uppercase'>
                    <div>
                ...
                <div className='text-right'>
                    <div className='w-full flex justify-end'>
                        <div className='w-full md:w-80 py-4 relative'>
